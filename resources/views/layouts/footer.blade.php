            ...
            <div><img src="{{ asset('storage/' . $siteData->logo) }}" alt="ARK Power Ltd.">
                <div class="text-center my-4">
                    ...
                    <div class="flex justify-center items-center gap-3 mt-2"><a target="_blank"
                            ...
                            </svg></a><a target="_blank" href="{{ $siteData->twitterUrl }}"><svg stroke="currentColor"
                            ...
                            </svg></a><a target="_blank" href="{{ $siteData->instragramUrl }}"><svg
                            ...
                            </svg></a><a target="_blank" href="{{ $siteData->youtubeUrl }}"><svg stroke="currentColor"
