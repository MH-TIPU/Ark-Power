        ...
        <div class="flex flex-col items-center ">
            ...
            <div class="text-center my-4">
                ...
                <div class="flex justify-center items-center gap-3 mt-2"><a target="_blank"
                        href="https://www.facebook.com/"><svg stroke="currentColor" fill="currentColor"
                        ...
                        </svg></a><a target="_blank" href="https://www.instagram.com/"><svg
            ...
            <ul class="space-y-2 pr-5">
                ...
                <li>
                    <form class="mt-3 md:block flex items-center justify-center"><input type="email"
                            id="subscriber" name="subscriber" placeholder="Enter Your Email"
                            class="p-2"><button type="submit" class="bg-[#209fd1] p-2">Subscribe</button>
                    </form>
                </li>
            </ul>
        </div>
