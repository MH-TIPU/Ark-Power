                    ...
                    <div class="grid md:grid-cols-3 gap-12">
                        <div class="md:col-span-2 space-y-8">
                            <div class="grid md:grid-cols-2 gap-8">
                                <div
                                    class="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300 border border-blue-200">
                                    <h1 class="text-2xl font-bold text-blue-600 mb-4 flex items-center"><svg
                                            stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512"
                                            class="inline-block mr-3 text-blue-600 text-3xl" height="1em" width="1em"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z">
                                            </path>
                                        </svg> Corporate Branch:</h1>
                                    <p class="text-gray-700 leading-relaxed">12B Ataturk Tower <br>22 Kemal
                                        Ataturk Avenue, Banani, Dhaka-1213.</p>
                                </div>
                                <div
                                    class="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300 border border-blue-200">
                                    <h1 class="text-2xl font-bold text-blue-600 mb-4 flex items-center"><svg
                        ...
                        <div
                            class="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300 border border-blue-200 space-y-8">
                            <div class="">
                                <h1 class="text-2xl font-bold text-blue-600 mb-4 flex items-center"><svg
                                ...
                                <p class="text-gray-700 leading-relaxed">Sales – 01678090037 <br> Support –
                                    01678090036</p>
                            </div>
                            <div class="">
                                <h1 class="text-2xl font-bold text-blue-600 mb-4 flex items-center"><svg
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-700 leading-relaxed">info@arkpowerltd.com.bd</p>
                            </div>
                        </div>
                    </div>
                </div>
