        ...
        <div class="shadow-md w-full fixed top-0 z-50 bg-white left-0 py-2">
            <div class="flex items-center justify-between container mx-auto p-4">
              ...
              <div onclick="toggleMenu()" class="absolute right-8 cursor-pointer lg:hidden w-7 h-7">
                <svg id="menuIcon" class="fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <path d="M3 12h18v-2h-18v2zm0 7h18v-2h-18v2zm0-14v2h18v-2h-18z"/>
                </svg>
                <svg id="closeIcon" class="hidden fill-current text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <path d="M19 6.41l-1.41-1.41-5.59 5.59-5.59-5.59-1.41 1.41 5.59 5.59-5.59 5.59 1.41 1.41 5.59-5.59 5.59 5.59 1.41-1.41-5.59-5.59z"/>
                </svg>
              </div>
          
              <ul id="navLinks" class="hidden lg:flex items-center absolute lg:static bg-slate-200 lg:bg-transparent w-full text-bold lg:w-auto left-0 top-14 lg:top-auto opacity-100 lg:opacity-100 transition-all duration-500 ease-in text-center">
                ...
                <li class="lg:ml-8 my-2 lg:my-0">
                  <a href="/products" class="text-gray-800 hover:text-blue-500 duration-500">Products</a>
                </li>
                <li class="lg:ml-8 my-2 lg:my-0">
